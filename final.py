...
def one_simal_pos_init(ray_min, ray_max):
    x = random.randint(1, 100000000) * random.choice([-1, 1]) #position sur l axe x
    y = random.randint(1, 100000000) * random.choice([-1, 1]) #position sur l axe y

    while math.sqrt(x*x + y*y) > ray_max or math.sqrt(x*x + y*y) < ray_min:
        x = random.randint(1, 100000000) * random.choice([-1, 1])
        y = random.randint(1, 100000000) * random.choice([-1, 1])
    return (x,y)
